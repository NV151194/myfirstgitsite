...
const respond = (request, response) => {
    ...
    if(stats.isDirectory()){
        ...
        data = data.replace('page_title', folderName); //for tittle of the webpage
        data = data.replace('pathname', breadcrumb);   // for locate the path of the webpage 
        data = data.replace('mainContent', mainContent); // for  main content of the webpage
